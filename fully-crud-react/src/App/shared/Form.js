...
class Form extends Component {
    ...
    handleSubmit(e) {
        ...
        if(this.props.clear) this.clearInputs(); //Short hand way to write if statement
    }
        ...
        return (
            <form onSubmit={this.handleSubmit}>
                ...
                <label htmlFor="completed">
                    Completed:
                    <input onChange={this.handleChange}checked={completed} name="completed" id="completed" type="checkbox" placeholder="" />
                </label>
